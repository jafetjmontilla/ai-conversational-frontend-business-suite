...
interface ProtocolDraftFormProps {
  ...
  onCancel: () => void;
  /** Sin Card; borde resaltado para revisión inline en listas. */
  embedded?: boolean;
}
      ...
      <div>
        ...
        {embedded && (
          <p className="text-sm text-muted-foreground mt-1">
            {isPublished
              ? "Guarda para actualizar el registro y reindexar en Knowledge-RAG."
              : "Guarda el borrador y publícalo cuando esté listo para el agente."}
          </p>
        )}
      </div>
      <span
  ...
  return (
    <>
      <Card>
        ...
        <CardContent className="space-y-4 max-w-2xl">{formBody}</CardContent>
      </Card>
    </>
  );
}
