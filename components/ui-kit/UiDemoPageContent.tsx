...
const COMPONENT_CATALOG: { folder: string; files: string[] }[] = [
  ...
  { folder: 'catalog/', files: ['AttributesCatalogContent', 'CategoriesCatalogContent', 'ProductFormPanel', 'ProductPhotosField', 'ProductsCatalogContent', 'ServicesCatalogContent'] },
