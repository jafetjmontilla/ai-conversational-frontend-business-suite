...
import { Home, Users, Bell, ChevronLeft, ChevronRight, SquareArrowOutUpRight, Building2, Pencil, UserPlus, BookOpen, Settings, MessageSquare, Package, FileText, CreditCard, FileBarChart, Briefcase, Brain, FileSearch, ShoppingCart, Sparkles } from 'lucide-react';
  ...
  const buildPersonalItems = (): NavItem[] => {
    if (!isSystemScope) {
      return [
        ...
        { href: `/${businessId}/pae`, label: 'PAE (episodios y flujos)', icon: Sparkles, condition: canViewCurrentBusiness },
