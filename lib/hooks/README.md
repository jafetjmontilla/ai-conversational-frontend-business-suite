...
El hook `useAllowed` adminporciona un sistema completo de permisos y autorizaciones para la aplicación Kiterai, basado en el rol del usuario y otros criterios de seguridad.
